...
class ShieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shield" do
    assert_difference("Shield.count") do
      post shields_url, params: { shield: { damage_reduction: @shield.damage_reduction, name: @shield.name } }
    end
  ...
  test "should update shield" do
    patch shield_url(@shield), params: { shield: { damage_reduction: @shield.damage_reduction, name: @shield.name } }
